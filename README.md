...
3. [Pick and Place Machine](/Files/docs/pickAndPlace.md)
    ...
    2. [Editing File](/Files/docs/pickAndPlace.md#editing)
        1. [Heads](/Files/docs/pickAndPlace.md#heads)
        2. [Stacks](/Files/docs/pickAndPlace.md#stacks)
        3. [Components](/Files/docs/pickAndPlace.md#components)
        4. [Batch](/Files/docs/pickAndPlace.md#batch)
        5. [Calibration](/Files/docs/pickAndPlace.md#calib)
    3. [Loading File and Running](/Files/docs/pickAndPlace.md#run)

4. [CHM-560P4 Documentation](/Files/docs/chm.md)
